...
typedef int (*deal_srv_cmd_t)( void* ndev,int argc,char** argv );
...
extern void event_report_curr( void* ndev,event_pt event );
extern void event_report_m_tenance( void* ndev,event_pt event );
