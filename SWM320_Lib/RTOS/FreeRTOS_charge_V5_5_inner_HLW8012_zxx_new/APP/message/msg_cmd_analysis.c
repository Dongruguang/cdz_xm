...
#define PRT_FuncName( str ) { PRT_LOG("call %s\r\n",__FUNCTION__); }
//-------------------------------------------------------------------------
static int deal_message_logon( void* ndev,int argc,char** argv )
{
	PRT_FuncName( dat );
	//接收回调，按理说不需要处理这个东西
...
static int deal_message_relogin( void* ndev,int argc,char** argv )
{
	PRT_FuncName( dat );
	//接收回调
...
static int deal_message_nologin( void* ndev,int argc,char** argv )
{
	PRT_FuncName( dat );
	//接收回调，按理说不需要处理这个东西
	int result = 0,i=0;
...
//-------------------------------------------------------------------------
static int deal_message_over( void* ndev,int argc,char** argv )
{
	PRT_FuncName( dat );
...
//-------------------------------------------------------------------------
static int deal_message_log( void* ndev,int argc,char** argv )
{
	PRT_FuncName( dat );
	//接收回调，按理说不需要处理这个东西
...
//-------------------------------------------------------------------------
static int deal_message_pong( void* ndev,int argc,char** argv )
{
	PRT_FuncName( dat );
...
//-------------------------------------------------------------------------
static int deal_message_PARAM( void* ndev,int argc,char** argv )
{
	PRT_FuncName( dat );
...
//-------------------------------------------------------------------------
static int deal_message_STATU( void* ndev,int argc,char** argv )
{
	PRT_FuncName( dat );
...
static int deal_message_jfpg( void* ndev,int argc,char** argv )
{
	PRT_FuncName( dat );
...
//-------------------------------------------------------------------------
static int deal_message_time( void* ndev,int argc,char** argv )
{
	PRT_FuncName( dat );
...
//-------------------------------------------------------------------------
static int deal_message_setparam( void* ndev,int argc,char** argv )
{
	PRT_FuncName( dat );
...
//-------------------------------------------------------------------------
static int deal_message_getstatu( void* ndev,int argc,char** argv )
{
	PRT_FuncName( dat );
...
//-------------------------------------------------------------------------
static int deal_message_update( void* ndev,int argc,char** argv )
{
	PRT_FuncName( dat );
	char ddh[MaxDDH_Len];
...
*/
static int deal_message_on( void* ndev,int argc,char** argv )
{
	PRT_FuncName( dat );
...
static int deal_message_off( void* ndev,int argc,char** argv )
{
	PRT_FuncName( dat );
...
static int deal_message_reboot( void* ndev,int argc,char** argv )
{
	PRT_FuncName( dat );
...
static int deal_message_CLOSED( void* ndev,int argc,char** argv )
{
	PRT_FuncName( dat );
}
